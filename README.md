...
1. The user must have preexisting knowledge of the data in order to enter it into the search criteria. This website does not scrape data around the internet, rather, it takes data from a specific file in order to spurn out results. This hinders the user's ability to find more data on the subject. 
